Write-Output "Starting Kafka Test"
Get-Date
...
Get-Date
kubectl apply -f .\KafkaScenarios\manifests-scenario10-DB1
Start-Sleep -s 5400

Write-Output "manifests-scenario3-steady33"
Get-Date
kubectl apply -f .\KafkaScenarios\manifests-scenario3-steady33
Start-Sleep -s 1800
...
Get-Date
kubectl apply -f .\KafkaScenarios\manifests-scenario9-10and100every1min
Start-Sleep -s 1800

Write-Output "scenario8-10and100every2min"
Get-Date
kubectl apply -f .\KafkaScenarios\manifests-scenario8-10and100every2min
Start-Sleep -s 1800

Write-Output "scenario7-10and100every5min"
Get-Date
kubectl apply -f .\KafkaScenarios\manifests-scenario7-10and100every5min
Start-Sleep -s 2400

Write-Output "scenario6-10and100every10min"
Get-Date
kubectl apply -f .\KafkaScenarios\manifests-scenario6-10and100every10min
Start-Sleep -s 3600
